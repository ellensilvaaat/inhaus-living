export const designClarityEmail = (firstName = "", email = "") => `
<div style="
background:#f1f0ee;
padding:70px 0;
...
color:#1a1a1a;
">
Why Design Clarity Matters Before Any Renovation
</h1>
...
margin-bottom:22px;
">
At Inhaus Living, every successful renovation begins with one thing: <strong>design clarity</strong>.
</p>
...
margin-bottom:24px;
">
Before demolition starts, before trades are scheduled, and before budgets are finalised, the design phase shapes everything that follows.
</p>
...
margin-bottom:24px;
">
When design is rushed or treated as a secondary step, projects often face unexpected costs, delays, and results that fall short of the original vision.
</p>
...
<li>Why renovation success begins long before demolition</li>
<li>How thoughtful design protects your renovation budget</li>
<li>How a well-planned design transforms outdated spaces into modern homes</li>
...
margin-bottom:24px;
">
By planning first, we help homeowners avoid costly rework and achieve results that feel effortless, cohesive and timeless.
</p>
...
margin-bottom:30px;
">
When design leads the way, everything else follows.
</p>
...
">
See Real Renovation Transformations
</a>
