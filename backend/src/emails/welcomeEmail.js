...
margin-bottom:24px;
">
Renovating or building a home is one of the biggest decisions you’ll ever make.  
We believe the process should feel exciting, clear and well supported — not overwhelming or stressful.
</p>
...
margin-bottom:18px;
">
Through this email series you'll receive:
</p>
...
<li>Smart renovation ideas</li>
<li>Design and planning insights</li>
<li>Real project stories</li>
<li>Practical guides to help you make confident decisions</li>
...
margin-bottom:24px;
">
At <strong>Inhaus Living</strong>, we take a design-first, end-to-end approach.  
Every project starts with a clear vision, realistic planning and full transparency — from concept through to completion.
</p>
...
margin-bottom:30px;
">
No fragmented teams.<br/>
No guesswork.<br/><br/>
Just one experienced team guiding you every step of the way.
</p>
...
<!-- SIGNATURE -->
<tr>
<td style="padding:0 70px 60px 70px;text-align:left;">
